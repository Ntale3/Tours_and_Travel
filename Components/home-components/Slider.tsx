...
const Slider = ({destinations}:{destinations:destType[]}) => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden pb-4">
         {/* Background Image */}
      ...
      <div className="absolute inset-0 transition-all duration-1000 ease-in-out">
            ...
            <button
                onClick={prevSlide}
                className="absolute left-1 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-transparent  rounded-full flex items-center justify-center hover:bg-white/20 transition-all duration-300 "
            >
